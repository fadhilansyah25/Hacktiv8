...
export default class MembersMeetupDetails extends React.Component {
  render() {
    return (
      <section className="container max-w-5xl mx-auto mt-10">
        ...
        <div className="mt-10 flex justify-center">
          <div>
            <a
              href="/"
              className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-blue-600 hover:bg-purple-800 focus:shadow-outline focus:outline-none"
            >
              See more
            </a>
          </div>
